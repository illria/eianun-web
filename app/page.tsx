...
const tools: Tool[] = [
  { name: "欧易 OKX", mark: "OKX", icon: "https://www.okx.com/favicon.ico", category: "加密交易所", label: "交易入口", detail: "适合先了解现货、转账与基础资产管理。", code: "SOL999", link: "https://www.okx.com" },
  { name: "币安 Binance", mark: "BNB", icon: "https://www.binance.com/favicon.ico", category: "加密交易所", label: "多币种入口", detail: "适合需要多币种与长期管理的人。", code: "TALA888", link: "https://www.binance.com" },
  { name: "Bybit", mark: "BB", icon: "https://www.bybit.com/favicon.ico", category: "加密交易所", label: "交易与资产", detail: "把交易、转账和资产入口集中在一起。", code: "NIFULEI20", link: "https://www.bybit.com" },
  { name: "OneKey", mark: "OK", icon: "https://onekey.so/favicon.ico", category: "冷钱包", label: "离线保管", detail: "将长期持有的资产从交易平台移出管理。", code: "NIFULEI", link: "https://onekey.so" },
  { name: "SafePal", mark: "SP", icon: "https://www.safepal.com/favicon.ico", category: "冷钱包", label: "硬件钱包", detail: "硬件设备与移动端配合使用的保管方案。", code: "766177", link: "https://www.safepal.com" },
  { name: "Ledger", mark: "LGR", icon: "https://www.ledger.com/favicon.ico", category: "冷钱包", label: "专业保管", detail: "适合建立更严格的私钥与设备管理习惯。", link: "https://www.ledger.com" },
  { name: "盈立证券 uSMART", mark: "U", icon: "https://www.usmart.hk/favicon.ico", category: "券商", label: "港美股入口", detail: "把开户、入金与交易的基础问题拆开看。", code: "U02662", link: "https://www.usmart.hk" },
  { name: "Interactive Brokers", mark: "IB", icon: "https://www.interactivebrokers.com/favicon.ico", category: "券商", label: "全球市场", detail: "覆盖市场广，适合需要专业工具的人。", link: "https://www.interactivebrokers.com" },
  { name: "Wise", mark: "W", icon: "https://wise.com/favicon.ico", category: "银行卡", label: "多币种转账", detail: "跨境收款、换汇与转账的常见入口。", link: "https://wise.com" },
  { name: "N26", mark: "N26", icon: "https://n26.com/favicon.ico", category: "银行卡", label: "数字银行", detail: "欧洲数字银行方向的账户入口。", code: "yanmingk73062c", link: "https://n26.com" },
  { name: "giffgaff", mark: "GG", icon: "https://www.giffgaff.com/favicon.ico", category: "跨境通讯", label: "英国号码", detail: "英国号码与流量方案，适合出境连接。", link: "https://www.giffgaff.com" },
